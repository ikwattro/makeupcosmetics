...
use Store\CountryBundle\Entity\Country;
use Store\CountryBundle\Form\CountryType;
...
class CountryController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('StoreCountryBundle:Country')->findAll();
     ...
     * @Method("POST")
     * @Template("StoreCountryBundle:Country:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('StoreCountryBundle:Country')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("StoreCountryBundle:Country:edit.html.twig")
     */
