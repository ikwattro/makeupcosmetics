...
class ProfileController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('StoreCustomerBundle:Profile')->findAll();
     ...
     * @Method("POST")
     * @Template("StoreCustomerBundle:Profile:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('StoreCustomerBundle:Profile')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("StoreCustomerBundle:Profile:edit.html.twig")
     */
